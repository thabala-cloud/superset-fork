...
# For database connections, this dictionary will add engines from the available
# list/dropdown if you do want only these dbs to show as available.
# The available list is generated by driver installed, and some engines have multiple
# drivers.
# e.g., DBS_AVAILABLE_ALLOWLIST: Dict[str, Set[str]] = {"hive": {"thrift", "rest"}}
DBS_AVAILABLE_ALLOWLIST: Dict[str, Set[str]] = {}
...
# Shillelagh adapters
SHILLELAGH_ALLOWED_ADAPTERS: List[str] = []
